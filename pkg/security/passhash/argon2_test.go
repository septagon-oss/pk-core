...
func TestArgon2idVerifyRejectsHostileInputs(t *testing.T) {
	...
	cases := []struct {
		...
		{"memory below constructor floor", "$argon2id$v=19$m=1,t=3,p=4$YWJjZGVmZ2g$AAAAAAAAAAAAAAAAAAAAAA"},
		{"memory above hasher policy", "$argon2id$v=19$m=65537,t=3,p=4$YWJjZGVmZ2g$AAAAAAAAAAAAAAAAAAAAAA"},
		{"iterations above hasher policy", "$argon2id$v=19$m=65536,t=4,p=4$YWJjZGVmZ2g$AAAAAAAAAAAAAAAAAAAAAA"},
		{"parallelism above hasher policy", "$argon2id$v=19$m=65536,t=3,p=5$YWJjZGVmZ2g$AAAAAAAAAAAAAAAAAAAAAA"},
