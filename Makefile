...
fitness:
	$(GO_ENV) go test -race -count=1 ./pkg/architecture ./pkg/authz ./pkg/entity ./pkg/mutation ./pkg/registry ./pkg/observability/... ./pkg/security/... ./pkg/resilience/... ./pkg/event/... ./pkg/infrastructure/...
